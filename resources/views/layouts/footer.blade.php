...
<footer class="bg-gray-900 py-15 mt-20">
    <div class="container mx-auto flex justify-between items-center px-6">
        ...
        <div class=" flex">
         ...
         <div class=" container mx-auto flex justify-center items-center px-20">

                <!-- Facebook -->

                <a class="  px-3" href="https://www.facebook.com/profile.php?id=100001228804294&mibextid=ZbWKwL">
                    <svg
                ...
                <!-- Instagram -->
                <a class=" px-3" href="https://instagram.com/osmanshikh?igshid=Yjk4NWM2ZWVkMw==">
                ...
                <!-- Twitter -->
                <a class=" px-3" href="https://twitter.com/Osman_Shikh?t=NGJ9t7uxLOsRhxT5r4dR6w&s=09">
                    <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7"
                fill="currentColor"
